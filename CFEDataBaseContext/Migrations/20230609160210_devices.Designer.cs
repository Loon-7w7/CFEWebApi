...
namespace CFEDatabase.Migrations
{
    ...
    [Migration("20230609160210_devices")]
            ...
            modelBuilder.Entity("CFE_Domain.Usuario.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f46aa503-7b96-452d-9488-c06128b63637"),
                            CreateDate = new DateTime(2023, 6, 9, 10, 2, 10, 262, DateTimeKind.Local).AddTicks(7276),
                            Password = "123456789",
                            Role = 0,
                            UpdateDate = new DateTime(2023, 6, 9, 10, 2, 10, 262, DateTimeKind.Local).AddTicks(7285),
                            Username = "Loon"
                        });
                });
